      ...
      <div className="gallery">
        ...
        <div className="frame thumb-1">
          <img
            ...
            alt="Cat 1"
            onClick={() =>
              setSelected({ image: '/images/cat1.jpg', interactionType: 'hold', frameFolder: '1' })
            }
          />
        </div>
        ...
        <div className="frame thumb-2">
          <img
            ...
            alt="Cat 2"
            onClick={() =>
              setSelected({ image: '/images/cat2.jpg', interactionType: 'click', frameFolder: '2' })
            }
          />
        </div>
        ...
        <div className="frame thumb-3">
          <img
            ...
            alt="Cat 3"
            onClick={() =>
              setSelected({ image: '/images/cat3.jpg', interactionType: 'drag' })
            }
          />
        </div>
        ...
        <div className="frame thumb-4">
          <img
            ...
            alt="Cat 4"
            onClick={() =>
              setSelected({ image: '/images/cat4.jpg', interactionType: 'keyboard' })
            }
          />
        </div>
        ...
        <div className="frame thumb-5">
          <img
            ...
            alt="Cat 5"
            onClick={() =>
              setSelected({ image: '/images/cat5.jpg', interactionType: 'typing' })
            }
          />
        </div>
        ...
        <div className="frame thumb-6">
          <img
            ...
            alt="Cat 6"
            onClick={() =>
              setSelected({ image: '/images/cat6.jpg', interactionType: 'mouse', frameFolder: '6' })
            }
          />
        </div>
